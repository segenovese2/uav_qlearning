# [file name]: uav_qlearning/train_qnet.py
...
def train_qnet(show_training=True):
    ...
    # Create Q-Network agent with adjusted parameters
    agent = QNetAgent(
    ...
    print("\nStarting Q-Network training for UAV trajectory optimization...")
    ...
    try:
        for episode in range(num_episodes):
            ...
            while not (terminated or truncated):
                ...
                # Update Q-Network with shaped reward
        ...
        # Save results
        agent.save_model('trained_qnet_model.pth')
        agent.save_training_stats('training_stats_qnet.json')
        ...
        agent.save_model('trained_qnet_model_interrupted.pth')
        agent.save_training_stats('training_stats_qnet_interrupted.json')
    finally:
        env.close()
...
if __name__ == "__main__":
    agent = train_qnet(show_training=True)
